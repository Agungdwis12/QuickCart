      ...
      <div className="min-h-screen bg-gray-100 text-gray-900 flex flex-col items-center justify-center px-6 py-12">
        <div className="max-w-3xl bg-white p-8 rounded-2xl shadow-lg text-center">
          ...
          <p className="text-gray-600 text-lg">
            ...
            <span className="font-semibold text-blue-600">Next.js, MongoDB, Inngest, Cloudinary, Clerk</span>, dan <span className="font-semibold text-blue-600">Vercel</span>, aplikasi ini dirancang untuk memberikan pengalaman jual beli
          ...
          <ul className="text-gray-600 text-lg mt-3 space-y-2">
            ...
            <li>✅ Menambahkan alamat</li>
            <li>✅ Order produk dengan mudah</li>
          </ul>

          <h2 className="text-2xl font-bold text-gray-700 mt-6">❌ Kekurangan</h2>
          <ul className="text-gray-600 text-lg mt-3 space-y-2">
            <li>🚫 Belum terintegrasi dengan payment gateway</li>
            <li>🚫 Belum bisa melakukan pembayaran </li>
          </ul>
